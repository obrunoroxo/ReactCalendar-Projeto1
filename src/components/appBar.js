...
import ConsultSchedule from "./modalComponents/consultSchedule";

const settings = ["Login", "Logout"];
const pages = ["Exportar", "Agendamento", "Valores pendentes"];
...
function ResponsiveAppBar() {
  ...
  return (
    <>
    <ModalContext.Provider value={{open1, setOpen1}}>
      <ConsultSchedule />
            ...
            <Box sx={{ flexGrow: 0 }}>
              <Tooltip title="Open settings">
                <IconButton
                  ...
                  sx={{ p: 0 }}
                >
                  <Avatar alt={userData.username} src={userData.link} />
                </IconButton>
              </Tooltip>
              <Menu
                id="menu-appbar"
              ...
              >
                <MenuItem key={settings[0]}>
                  <Typography textAlign="center" onClick={() => setOpen(true)}>
                    {settings[0]}
                  </Typography>
                </MenuItem>
